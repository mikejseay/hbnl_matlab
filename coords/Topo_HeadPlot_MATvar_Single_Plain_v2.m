function Topo_HeadPlot_MATvar_Single_Plain_v2(data2plot, subtitle, scale_min, scale_max, contour_levels, outline_width, dots_size, ColorBar_YesHorz1_YesVert2_No0)
% Topo_HeadPlot_MATvar_Single_Plain(data2plot, subtitle, scale_min, scale_max, contour_levels, outline_width, dots_size, ColorBar_YesHorz1_YesVert2_No0)
% [This program plots the scalp topography (i.e. HeadPlot) for the given data] {***Program compiled by Chella Kamarajan***)
...
coord61 = load('Electrode_Coordinates_61.csv');
