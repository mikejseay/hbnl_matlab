	file_list = '/active_projects/chorlian/phase4_ern/SUNY.phase4_baseline_ern.files.part_1';
	output_dir = '/active_projects/chorlian/phase4_ern';
	data_file_type = 'hdf_binary';
	info_file = [];
	load ern_params_06_15.mat
	param_struct = ern_params_06_15;
	option = [true, false, true, false];
	suffix = 'f16_20';
	log_file = '/active_projects/chorlian/phase4_ern/SUNY.phase4_baseline_ern.files.part_1.err';
