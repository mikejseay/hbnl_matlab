function [S_values, abs_S, inv_S, t, f] = calc_chan_stockwell_values_ms(h1_struct, min_frequencies, max_frequencies, min_time_ms, max_time_ms, value_type, chan_name, st_type, apply_baseline, baseline_type, st_baseline_time_min_ms, st_baseline_time_max_ms, out_type)
%
...
[abs_S, inv_S, t, f] = calc_chan_stockwell_power_ms(h1_struct, chan_name, st_type, apply_baseline, baseline_type, st_baseline_time_min_ms, st_baseline_time_max_ms, out_type);
