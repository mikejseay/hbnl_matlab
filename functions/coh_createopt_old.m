function opt = coh_createopt_old
...
uilist = {    { 'Style', 'text', 'string', 'Text file containing list of full data file path(s)', 'horizontalalignment', 'right' }, ...
              { 'Style', 'edit', 'string', '/active_projects/mike/fmri_phase4_err/fmri_err_cnth1s', 'horizontalalignment', 'left', 'tag',  'Pathfile' }, ...
              ...
              { 'Style', 'edit', 'string', '_FPO82' }, ...
              { 'Style', 'text', 'string', '' }, ...
              ...
              { 'Style', 'text', 'string', 'Folder to place output .mats:', 'horizontalalignment', 'right' }, ...
              { 'Style', 'edit', 'string', '/active_projects/mike/fmri_err_FPO82', 'horizontalalignment', 'left', 'tag',  'Outpath' }, ...
              ...
              { 'Style', 'edit', 'string', '/export/home/mike/matlab/batch/err_FPO82', 'horizontalalignment', 'left', 'tag',  'Optpath' }, ...
...
opt=v2struct(infile_list, data_type, coords_file, trial_init_type, case_vec, ...
    ...
    csd_G, csd_H, freq_lims, padratio, n_samps, wavelet_scales, tf_timedownsamp_ratio, ...
    coherence_pairs, pair_inds, pair_indlbls, ...
...
opt=v2struct(infile_list, data_type, coords_file, trial_init_type, case_vec, ...
    case_label, chan_vec, n_chans, rate, epoch_lims, prestim_ms, ...
    lengthen, artf_ms_vec, epochrej_method, thresh, cleanset, hpfilt_bands, ...
    freq_lims, padratio, n_samps, wavelet_scales, tf_timedownsamp_ratio, ...
    coherence_pairs, pair_inds, pair_indlbls, ...
    measures, outsuffix, outpath, batchpath, optpath, ...
    batch_id, batchscripts, logpath, save_clean, cleandir, getbehav, ...
    n_cohperms, reref, rng_seed, vis, vis_path, coherence_type);
