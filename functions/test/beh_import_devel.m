% script for collecting behavioral data from a number of behavioral data
% .mats

tic;

% load the opt
load('ph4-baseline-dirs-gawked-dirsonlyph4_tb_opt.mat')
...
etime = toc; % 44 secs for 2000 subs, mostly loading the .mats