...
geometry    = { [2 1 1.5] [2 1 1.5] [1] [2 1 1.5] [3.33 1.66 1 1.5] [2 1 1.5] [2 1 1.5] [2 1 1.5] ...
                [1] [2 1 1.5] [2 1 1.5]};
                
uilist = {    { 'Style', 'text', 'string', 'Text file containing full *.cnt.h1 path(s)', 'horizontalalignment', 'right' }, ...
              ...
              { 'Style', 'edit', 'string', '[31 63 64]', 'tag', 'chans' }, ...
...
results = inputgui(geometry, uilist, 'help create_param_struct;', 'Set Up Option for Data Processing - create_param_struct');
