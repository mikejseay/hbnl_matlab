...
for j=1:n_chans
    ...
    [S_values, S, inv_S, t, f] = calc_chan_stockwell_values(h1_struct, min_frequencies, max_frequencies, min_time_ms, max_time_ms, value_type, chan_name, st_type, apply_baseline, baseline_type, st_baseline_time_min_ms, st_baseline_time_max_ms, out_type);  
