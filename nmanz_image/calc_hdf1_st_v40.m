function calc_hdf1_st_v40(cnthdf1_filename, working_directory, the_case, chan_list_type,baseline_type,st_baseline_time_min_ms,st_baseline_time_max_ms, min_trials, max_trials, new_pre_stim_time_ms, new_threshold_value,new_threshold_min_time_ms, new_threshold_max_time_ms, new_hi_pass, new_lo_pass, new_threshold_electrodes) 
%
...
txt_file_name = [sub_id,'.st.mat.v4.0.log'];
...
fid = fopen(txt_file_name, 'wt');
    ...
    h1_struct = create_cnthdf1_baseline_epoch_data_v40(h1_struct, txt_file_name, new_hi_pass, new_lo_pass, new_threshold_electrodes);
